...
Summary: QAQC code for original FMH PICO plots                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
...
2. Transect Length = 6, 6, 12 for 1hr, 10hr, 100hr
3. FWD fuel constant = correct
4. Azimuth is reasonable
...
# 2. Azimuth Check
azimuth_range_check <- fuelsfine_df$Azimuth %in% 0:359

errors_FuelsFine <- bind_rows(errors_FuelsFine,
  check_qaqc(
    fuelsfine_df,
    "Fine Fuel Azimuth",
    "Azimuth value not in range 0–359",
    azimuth_range_check
  )
)
