...
directory_path <- "FFI data - WORKING/FMH_PIPO_2024/"
...
```{r}
errors_ALL <- rbind(errors_FuelsFine, errors_Fuels1000, errors_FuelsDL, errors_Trees, errors_cover, errors_shrubs, errors_seedlings)
errors_ALL <- unique(errors_ALL)

write_xlsx(errors_ALL, "Error Logs/2024FMHPIPO.xlsx")
